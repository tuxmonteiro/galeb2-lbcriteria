...
import com.globo.galeb.criteria.lb.LoadBalanceCriterionFactory;
...
public class LoadBalanceCriterion<T> implements ICriterion<T> {
    ...
    public ICriterion<T> when(Object aParam) {
        ...
        if (aParam instanceof RequestProperties) {
            RequestProperties requestProperties = (RequestProperties) aParam;
            this.loadBalanceName = requestProperties.getString(LOADBALANCE_POLICY_FIELDNAME,LOADBALANCE_POLICY_DEFAULT);
            this.param = aParam;
        }
